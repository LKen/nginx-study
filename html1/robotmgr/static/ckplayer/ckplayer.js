...
!(function() {
	...
	var ckplayer = function(obj) {
		...
		*/
		...
		//字体
		this.fontFamily = '"Microsoft YaHei"; YaHei; SimHei; ;Arial';
		//记录第一次拖动进度按钮时的位置
	...
	ckplayer.prototype = {
		...
		*/
		embedSWF: function() {
			...
			html += '<embed ' + param['w'] + ' src="' + src + '" flashvars="' + flashvars + '" width="100%" height="100%" ' + id + ' align="middle" type="application/x-shockwave-flash" wmode="transparent" pluginspage="' + flashplayerUrl + '" />';
			html += '</object>';
			this.PD.innerHTML = html;
